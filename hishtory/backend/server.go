...
var (
	...
	ReleaseVersion string = "208c"
	sqliteDb              = "hishtory.db"
)
...
func OpenDB() (*gorm.DB, error) {
	...
	if postgresDb == "" {
		...
		// docker compose 默认的 dsn
		// postgresDb := fmt.Sprintf("postgresql://postgres:%s@postgres:5432/hishtory?sslmode=disable", os.Getenv("POSTGRESQL_PASSWORD"))
